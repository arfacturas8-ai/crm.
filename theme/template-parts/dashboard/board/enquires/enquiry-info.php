...
<div class="lead-detail-wrap">
    ...
    <a class="edit_lead_js label primary-label edit-lead-detail open-close-slide-panel" href="#" data-id="<?php echo intval($enquiry->enquiry_id);?>">
