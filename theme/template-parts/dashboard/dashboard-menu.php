...
<ul class="side-menu list-unstyled">
    ...
    $crm_menu .= '<li class="side-menu-item link-activities">
        <a href="'.esc_url($crm_activities).'"><i class="houzez-icon icon-arrow-right-1"></i> '.houzez_option('dsh_activities', 'Actividades').'</a>
    </li>';
    $crm_menu .= '<li class="side-menu-item link-deals">
        <a href="'.esc_url($crm_deals).'"><i class="houzez-icon icon-arrow-right-1"></i> '.houzez_option('dsh_deals', 'Seguimiento').'</a>
    </li>';
    $crm_menu .= '<li class="side-menu-item link-leads">
        <a href="'.esc_url($crm_leads).'"><i class="houzez-icon icon-arrow-right-1"></i> '.houzez_option('dsh_leads', 'Base de datos').'</a>
    </li>';
    $crm_menu .= '<li class="side-menu-item link-inquiries">
        <a href="'.esc_url($crm_enquiries).'"><i class="houzez-icon icon-arrow-right-1"></i> '.houzez_option('dsh_inquiries', 'Buscar').'</a>
    </li>';
